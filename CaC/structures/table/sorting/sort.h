...
#include "../../../BuildingAreaComparator.h"
#include "../../../FarmlandComparator.h"
...
namespace structures
{
	...
	/// <summary> Triedenie UnsortedSequenceTable navrhnuté ako funkèný objekt. </summary>
	...
	public:
		...
		/// <param name = "table"> NonortedSequenceTable, ktoru ma utriedit. </param>
		virtual void sort(UnsortedSequenceTable<K, T>& table, Comparator<T>* comparator) = 0;
